...
class Test_Para_Bank:
    ...
    def test_find_transaction_date(self):
        ...
        transaction_id_text, transaction_amount_text = findtransactions.find_transaction_in_multiple_ways(find_transaction_value="find_transaction_date", transaction_values = transaction_date)
    ...
    def test_update_contact_info(self):
        ...
        fristname, lastname, streetaddress, cityaddress, stateaddress, zipcodeaddress, phonenumber = update_user_data['fname'],update_user_data['lname'], update_user_data['address'],update_user_data['city'], update_user_data['state'],update_user_data['zipcode'], update_user_data['phone']
